...
const customerSchema = new Schema({
    ...
    riskProfile: {
        ...
        purpose: { type: String, enum: ['Collections', 'Click2School', 'Disbursements', 'Remittance'], default: 'Collections' },
        ...
        productType: { type: String, enum: ['USSD', 'Payment Link', 'Payment Form', 'API Integration'], default: 'Payment Link' },
